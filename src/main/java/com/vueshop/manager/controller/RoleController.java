...
public class RoleController {
	...
	public HttpResponse<RoleInfoResponse> addRole(HttpServletRequest request, @PathVariable long roleId,
			@RequestBody AddRidsRequest rids) {
		HttpResponse<RoleInfoResponse> httpResponse = new HttpResponse<>(new Meta());
	...
	@ResponseBody
	public HttpResponse<List<MenuInfoResponse>> roleDeleteByRights(HttpServletRequest request,
			@PathVariable long roleId, @PathVariable long rightId) {
